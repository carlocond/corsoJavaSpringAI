package com.azienda.esercizio1SpringRest.controller;

import com.azienda.esercizio1SpringRest.model.Localita;
import com.azienda.esercizio1SpringRest.service.LocalitaService;
...
public class LocalitaController {
    ...
    public ResponseEntity<String> deleteByTemperaturaMinoreDi(@PathVariable Double valore) {
        int eliminate = localitaService.deleteByTemperaturaMinoreDi(valore);
    ...
    public ResponseEntity<String> deleteByTemperaturaMaggioreDi(@PathVariable Double valore) {
        int eliminate = localitaService.deleteByTemperaturaMaggioreDi(valore);
        return ResponseEntity.ok("Localita eliminate: " + eliminate);
    }
}
